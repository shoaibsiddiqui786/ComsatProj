...
namespace GUI_Task.PrintViewer
{
    public partial class frmPrintViewerRS : Form
    {
        ...
        public frmPrintViewerRS(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedger ds, CrTrial rptName, string p)
        {
        ...
        public frmPrintViewerRS(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedger ds, CrTrialOp rptName_2, string p)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
            this.fOptionalTitle1 = fOptionalTitle1;
        ...
        public frmPrintViewerRS(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedger ds, CrLedger rptName_3, string p)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
            this.fOptionalTitle1 = fOptionalTitle1;
        ...
        public frmPrintViewerRS(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedgerNew ds_2, CrTrial rptName, string p)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
            this.fOptionalTitle1 = fOptionalTitle1;
        ...
        public frmPrintViewerRS(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedgerNew ds_2, CrTrialOp rptName_2, string p)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
            this.fOptionalTitle1 = fOptionalTitle1;
        ...
        public frmPrintViewerRS(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedgerNew ds_2, CrLedger rptName_3, string p)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
            this.fOptionalTitle1 = fOptionalTitle1;
        ...
        public frmPrintViewerRS(string fRptTitle, DateTime dateTime, DateTime dateTime_2, string p, string plstField, string plstType, string plstValue, dsLedgerNew ds_2, CrLedger rpt1, string p_2)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
        ...
        private void atFormLoadEvent(object sender, EventArgs e)
        {
            if (fQtyType == "SP")
            {
                ExecuteSPData();
