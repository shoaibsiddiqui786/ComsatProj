...
namespace GUI_Task
{
    public partial class frmContractorWiseProdProc : Form
    {
        int fcboDefaultValue = 0;
        public frmContractorWiseProdProc()
        {
            InitializeComponent();
        }
        ...
        private void frmContractorWiseProdProc_KeyDown(object sender, KeyEventArgs e)
        {
