...
namespace GUI_Task
{
    public partial class frmIssueItemsBatchWise : Form
    {
        int fcboDefaultValue = 0;
        public frmIssueItemsBatchWise()
        {
            InitializeComponent();
        }
        ...
        private void frmIssueItemsBatchWise_Load(object sender, EventArgs e)
        {
            AtFormLoad();
            // blnFormLoad = false;
        ...
        private void frmIssueItemsBatchWise_KeyDown(object sender, KeyEventArgs e)
        {
