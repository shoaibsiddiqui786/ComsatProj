...
namespace GUI_Task
{
    public partial class frmAccReceive : Form
    {
        public frmAccReceive()
        {
            InitializeComponent();
        }

        private void account_Receivable_Load(object sender, EventArgs e)
        {
        ...
        {
            frmGrpSelect frm1 = new frmGrpSelect();
            frm1.Show();
        }

        private void frmAccReceive_KeyDown(object sender, KeyEventArgs e)
        {
