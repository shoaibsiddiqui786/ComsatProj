...
namespace GUI_Task
{
    public partial class frmSaleOdrEntryServ : Form
    {
        int fcboDefaultValue = 0;
        bool blnFormLoad = true;
        public frmSaleOdrEntryServ()
        {
            InitializeComponent();
        }
        ...
        private void frmSaleOdrEntryServ_Load(object sender, EventArgs e)
        {
            AtFormLoad();
            blnFormLoad = false;
        }
        ...
        private void cboOrderNo_DoubleClick(object sender, EventArgs e)
        {
            LookUp_Voc();
        }
