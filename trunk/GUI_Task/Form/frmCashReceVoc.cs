...
namespace GUI_Task
{
    public partial class frmCashReceVoc : Form
    {
        public frmCashReceVoc()
        {
            InitializeComponent();
        }
        ...
        private void cash_Repceipt_Voucher_Load(object sender, EventArgs e)
        {
