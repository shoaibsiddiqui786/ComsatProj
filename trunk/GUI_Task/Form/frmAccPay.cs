...
namespace GUI_Task
{
    public partial class frmAccPay : Form
    {
        public frmAccPay()
        {
            InitializeComponent();
        ...
        private void accounts_Payable_Load(object sender, EventArgs e)
        {
        ...
        private void frmAccPay_KeyDown(object sender, KeyEventArgs e)
        {
