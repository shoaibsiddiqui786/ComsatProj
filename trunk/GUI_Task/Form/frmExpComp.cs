...
namespace GUI_Task
{
    public partial class frmExpComp : Form
    {
        public frmExpComp()
        {
            InitializeComponent();
        ...
        private void expense_Comparison_Load(object sender, EventArgs e)
        {
        ...
        private void frmExpComp_KeyDown(object sender, KeyEventArgs e)
        {
