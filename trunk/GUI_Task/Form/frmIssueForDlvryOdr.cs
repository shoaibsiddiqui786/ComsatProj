...
namespace GUI_Task
{
    public partial class frmIssueForDlvryOdr : Form
    {
        int fcboDefaultValue = 0;
        bool blnFormLoad = true;
        public frmIssueForDlvryOdr()
        {
            InitializeComponent();
        }
        ...
        private void frmIssueForDlvryOdr_Load(object sender, EventArgs e)
        {
            AtFormLoad();
            blnFormLoad = false;
        }
        ...
        private void frmIssueForDlvryOdr_KeyDown(object sender, KeyEventArgs e)
        {
