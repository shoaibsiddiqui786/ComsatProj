...
namespace GUI_Task
{
    public partial class frmBillRece : Form
    {
        public frmBillRece()
        {
            InitializeComponent();
        ...
        private void bill_Wise_Receivables_Load(object sender, EventArgs e)
        {
        ...
        private void frmBillRece_KeyDown(object sender, KeyEventArgs e)
        {
